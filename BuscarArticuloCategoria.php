...
try
{
	$sql = "SELECT articulo.referencia, articulo.nombre, categoria.nombre, subcategoria.nombre, articulo.stock FROM `articulo` INNER JOIN subcategoria ON articulo.id_sub = subcategoria.id_sub INNER JOIN categoria ON subcategoria.id_cat = categoria.id_cat INNER JOIN proveedor ON articulo.id_prov = proveedor.id_prov WHERE categoria.nombre='".$categoria_articulo."' AND articulo.activo=1";
